...
class Contact implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(targetEntity: Ticket::class, mappedBy: 'contact', cascade: ['remove'])]
    ...
    {
        return $this->entreprise ? $this->entreprise->getName() : null;
    }
